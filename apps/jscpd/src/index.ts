import {getDefaultOptions, IClone, IMapFrame, IOptions, IStore, Statistic} from '@eklmv/jscpd-core';
...
import { getSupportedFormats, Tokenizer } from '@eklmv/jscpd-tokenizer';
